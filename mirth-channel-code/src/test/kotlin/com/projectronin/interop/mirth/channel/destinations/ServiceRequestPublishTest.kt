...
class ServiceRequestPublishTest {
    ...
    private val diagnosticReport1 = DiagnosticReport(
        id = Id("$tenantId-1234"),
    ...
    private val diagnosticReport2 = DiagnosticReport(
        id = Id("$tenantId-5678"),
        status = DiagnosticReportStatus.APPENDED.asCode(),
        code = CodeableConcept(),
        basedOn = listOf(
    ...
    private val diagnosticReport3 = DiagnosticReport(
        id = Id("$tenantId-9012"),
        status = DiagnosticReportStatus.APPENDED.asCode(),
        code = CodeableConcept()
    )
    ...
    private val observation1 = Observation(
        id = Id("$tenantId-1234"),
    ...
    private val observation2 = Observation(
        id = Id("$tenantId-5678"),
        status = ObservationStatus.REGISTERED.asCode(),
        code = CodeableConcept(),
        basedOn = listOf(
    ...
    private val observation3 = Observation(
        id = Id("$tenantId-9012"),
        status = ObservationStatus.REGISTERED.asCode(),
        code = CodeableConcept()
    )

    private val procedure1 = Procedure(
        id = Id("$tenantId-1234"),
    ...
    private val procedure2 = Procedure(
        id = Id("$tenantId-5678"),
        status = Code(value = "ProcedureCode"),
        code = CodeableConcept(),
        subject = Reference(),
    ...
    private val procedure3 = Procedure(
        id = Id("$tenantId-9012"),
        status = Code(value = "ProcedureCode"),
        code = CodeableConcept(),
        subject = Reference()
    ...
    fun `PatientPublishServiceRequestRequest supports loads resources`() {
        ...
        every { serviceRequestService.getServiceRequestsForPatient(tenant, "1234") } returns listOf(
            serviceRequest1,
            serviceRequest2
        )
