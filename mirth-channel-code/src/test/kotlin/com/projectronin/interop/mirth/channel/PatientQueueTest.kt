...
class PatientQueueTest {
    ...
    fun setup() {
        ...
        val patientQueueWriter = mockk<PatientQueueWriter>()
        val queueService = mockk<QueueService>()
        channel = PatientQueue(tenantService, mockTransformManager, patientQueueWriter, queueService, mockRoninPatient)
    }
