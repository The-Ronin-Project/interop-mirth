    ...
    constructor(objectFactory: ObjectFactory) {
        ...
        internal val channel: com.projectronin.interop.gradle.mirth.ChannelExtension =
            objectFactory.newInstance(
                com.projectronin.interop.gradle.mirth.ChannelExtension::class.java,
            )
...
open class ChannelExtension
    ...
    constructor(objectFactory: ObjectFactory) {
         ...
         */
        internal val tenantConfig: com.projectronin.interop.gradle.mirth.TenantConfigExtension =
            objectFactory.newInstance(
        ...
        internal val aidBoxConfig: com.projectronin.interop.gradle.mirth.AidboxExtension =
            objectFactory.newInstance(
                com.projectronin.interop.gradle.mirth.AidboxExtension::class.java,
            )
 ...
 */
open class TenantConfigExtension
    @Inject
    constructor(objectFactory: ObjectFactory) {
        /**
        ...
        internal val auth: com.projectronin.interop.gradle.mirth.TenantConfigAuthExtension =
            objectFactory.newInstance(
                com.projectronin.interop.gradle.mirth.TenantConfigAuthExtension::class.java,
            )
