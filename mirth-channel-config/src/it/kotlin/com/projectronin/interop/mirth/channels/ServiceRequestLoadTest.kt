...
import com.projectronin.interop.mirth.channels.client.mirth.serviceRequestGroupLoadChannelName
...
class ServiceRequestLoadTest : BaseChannelTest(
    ...
    fun `channel works with multiple service requests and appointments`(testTenant: String) {
        ...
        val fakeServiceRequest1 = serviceRequest {
        ...
        val fakeServiceRequest2 = serviceRequest {
            identifier of listOf(
                identifier {
                    system of "mockServiceRequestSystem"
        ...
        val fakeServiceRequest3 = serviceRequest {
            identifier of listOf(
                identifier {
                    system of "mockServiceRequestSystem"
                    value of "ServiceRequest/2"
        ...
        val fakeAppointment1 = rcdmAppointment(tenantInUse) {
            status of "arrived"
        ...
        val fakeAppointment2 = rcdmAppointment(tenantInUse) {
            status of "arrived"
            participant of listOf(
                participant {
                    status of "accepted"
        ...
        val fakeMedicationRequest = rcdmMedicationRequest(tenantInUse) {
            basedOn of listOf(reference("ServiceRequest", serviceRequestFhirId3))
        }

        val fakeMedicationStatement = rcdmMedicationStatement(tenantInUse) {
            basedOn of listOf(reference("ServiceRequest", serviceRequestFhirId1))
        }

        val fakeObservation = rcdmObservation(tenantInUse) {
            basedOn of listOf(reference("ServiceRequest", serviceRequestFhirId3))
        }
