...
import com.projectronin.interop.mirth.channels.client.mirth.diagnosticReportLoadChannelName
...
class DiagnosticReportLoadTest : BaseChannelTest(
    ...
    fun `channel works with multiple patients and diagnostic reports`(testTenant: String) {
        ...
        val fakeDiagnosticReport1 = diagnosticReport {
        ...
        val fakeDiagnosticReport2 = diagnosticReport {
    ...
    fun `channel works for ad-hoc requests`(testTenant: String) {
        ...
        val diagnosticReport1 = diagnosticReport {
            status of "registered"
            code of codeableConcept {
                coding of listOf(
                    coding {
